...
class _HomePageState extends State<HomePage>
  ...
  void _showGemmaDownloadBottomSheet(BuildContext context) {
            ...
            builder: (context) {
              return Padding(
                ...
                child: Column(
                  ...
                  children: [
                    Text(
                      "Download Gemma 3 Models", // Added a title for better UI
                      style: TextStyle(
                        fontSize: 20,
                    ...
                    Text(
                      "We need to download Gemma 3 smallest text model and Gemma 3 small vision model for handling private images and chats.",
                      style: TextStyle(
                        fontSize: 16,
                    ...
                    ElevatedButton(
                      onPressed: () {
                        ...
                        print("DEBUG: Adding HomeDownloadGemmaModel event");
                        homeBloc.add(HomeDownloadGemmaModel());
                      },
                          ...
                          child: Column(
                            ...
                            children: [
                              state.status == HomePageStatus.idle
                                  ? (state.gemmaDownloadStatus ==
                                          GemmaDownloadStatus.success
                                      ? Text(
                                          'Drissea',
                                          style: TextStyle(
                                            color: Colors.black,
                                    ...
                                    child: Row(
                                      ...
                                      children: [
                                        Icon(Iconsax.edit_2_outline,
                                            color: Color(0xFFDFFF00), size: 16),
                                        SizedBox(width: 3),
                                        Text(
                                          'Edit',
                              ...
                              children: [
                                Expanded(
                                  child: TextField(
                                    ...
                                    style: TextStyle(
                                      color:
                                          isUrl ? Colors.purple : Colors.black,
                                    ),
                                    decoration: InputDecoration(
                                      hintText: state.isSearchMode
                                          ? "Search or type url"
                                  ...
                                  children: [
                                              ...
                                              builder: (context, state) {
                                                return SourcesBottomSheet(
                                                  onImageSelected: (image) {
                                                    ...
                                                    homeBloc.add(HomeImageSelected(
                                                        image,
                                                        imageDescriptionNotifier));
                                                  },
                                                  onToggleMap: () {
                                    ...
                                    GestureDetector(
                                      onTap: () {
                                        final homeBloc =
                                            context.read<HomeBloc>();
                                        // If model is downloaded, toggle chat mode
                                        if (state.gemmaDownloadStatus ==
                                            GemmaDownloadStatus.success) {
                                          homeBloc.add(HomeToggleChatMode());
                                          print(
                                              "DEBUG: Chat mode toggled: ${!state.isChatModeActive}");
                                        } else {
                                          ...
                                          showModalBottomSheet(
                                            ...
                                            isScrollControlled: true,
                                            builder: (_) =>
                                                OfflineChatBottomSheet(
                                              onStartDownload: () {
                                                homeBloc.add(
                                                    HomeDownloadGemmaModel());
                                              },
                                              onNotNow: () {

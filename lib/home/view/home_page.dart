...
class _HomePageState extends State<HomePage>
  ...
  Widget _profileIconFallback() {
    final initials = _displayName.isNotEmpty && _displayName != 'Guest'
    ...
    return BlocProvider<HomeBloc>(
      ...
      child: BlocListener<HomeBloc, HomeState>(
        ...
        listener: (context, state) {
              ...
              builder: (dialogContext) => WillPopScope(
                onWillPop: () async {
                  ...
                  context.read<HomeBloc>().add(
                        HomeCancelOCRExtraction(imageDescriptionNotifier),
                      );
                  return true;
                },
                child: AlertDialog(
          ...
          } else if (state.ocrExtractionStatus == OCRExtractionStatus.success ||
              state.ocrExtractionStatus == OCRExtractionStatus.failed ||
              state.ocrExtractionStatus == OCRExtractionStatus.cancelled) {
                                ...
                                children: [
                                  Visibility(
                                    ...
                                    child: InkWell(
                                      onTap: () {
                                        context.read<HomeBloc>().add(
                                              SelectEditInputOption("", false,
                                                  -1, state.isSearchMode, ""),
                                            );
                                        taskTextController.text = "";
                                        isTaskValid = false;
                                      },

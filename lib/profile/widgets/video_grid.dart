...
import 'package:bavi/profile/widgets/video_set_player.dart';
...
class VideoGridScreen extends StatefulWidget {
  ...
  const VideoGridScreen(
      {Key? key, required this.savedVideos, required this.isLoading, required this.platformData,  this.collection})
      : super(key: key);
